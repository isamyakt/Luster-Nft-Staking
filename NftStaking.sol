...
contract ERC721Staking is  ReentrancyGuard {
    ...
    mapping(uint256 => address) public stakerAdress;
    ...
    function stake(uint256 _tokenId) external nonReentrant {
        ...
        stakerAdress[_tokenId] = msg.sender;
    ...
    function withdraw(uint256 _tokenId) external nonReentrant {
        ...
        require(stakerAdress[_tokenId] == msg.sender, "You don't own this token");
        ...
        stakers[msg.sender].amountStaked--;
        stakerAdress[_tokenId] = address(0);
